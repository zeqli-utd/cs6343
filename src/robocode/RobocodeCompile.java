	...
	public static void CompileFile(String rbtName, String pkgID){
		...
		try
		{
			...
			Process ps, ps1 = null;
				...
				ps = rt.exec("cmd /c java -cp C:/robocode/libs/robocode.jar robocode.Robocode -nodisplay");
				ps1 = rt.exec("cmd /c java -cp C:/robocode/compilers/ecj.jar org.eclipse.jdt.internal.compiler.batch.Main -deprecation -g -source 1.6 -encoding UTF-8 -classpath \"C:/Program Files (x86)/Java/jre1.8.0_66/lib/rt.jar\";c:/robocode/libs/robocode.jar C:/robocode/robots/"+pkgID+"/"+rbtName+".java" );
